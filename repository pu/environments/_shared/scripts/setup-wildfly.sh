...
# unzip $WILDFLY_ARCHIVE -d $WILDFLY_INSTALL_DIR
tar -xzf $WILDFLY_ARCHIVE -C $WILDFLY_INSTALL_DIR
...
#sudo chmod 777 /opt/wildfly/bin/standalone.conf
#sudo echo JAVA_HOME="/usr/local/java" >> /opt/wildfly/bin/standalone.conf
